...
(dom/h2 #js {} "The quick, brown fox (20px)")
(dom/h3 #js {} "The quick, brown fox (20px)")
(dom/h4 #js {} "The quick, brown fox (20px)")
(dom/h5 #js {} "The quick, brown fox (20px)")
(dom/h6 #js {} "The quick, brown fox (20px)")))
...
(def sections (vec (sort-by :title
                            [
                             ...
                             {:id :typographies :title "Lists" :examples [lists]}
                             ])))
